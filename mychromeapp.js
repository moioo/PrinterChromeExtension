/*
 ...
 Impresora: 047e:1001
 */
var MY_HID_VENDOR_ID = 0x047e; // 4660 in hexadecimal!
var MY_HID_PRODUCT_ID = 0x1001;
...
function transferData() {
    ...
    var info = {
        "direction": "out",
        "endpoint": 0, // 2 is the Bulk OUT Endpoint. You may use chrome.usb.listInterfaces to figure which address to use for Outputing data.
        "data": data
    };
